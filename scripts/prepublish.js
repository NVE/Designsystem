...
// dette scriptet kopierer package.json (uten devdeps og scripts) til dist mappe (etter den er bygget) og kjører pnpm publish derfra
...
if (command !== 'pack' && command !== 'publish') {
  console.log(`${chalk.red('✘')} Wrong package command. Use 'pack' or 'publish'`);
  process.exit(1);
}
