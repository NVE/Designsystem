...
til ledeteksten. Denne hjelpeteksten kan man plassere både over og under inndatafeltet.
...
<nve-textarea
  label="Ledetekst"
  helpText="En tekst som presiserer hva som skal fylles inn, men over inndatafeltet"
