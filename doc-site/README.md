...
VIKTIG! Når man kjører pnpm run dev første gang, skal appen rerendres på nytt etter en stund. Grunnen er dynamiske importer
...
Når du legger til en ny komponent under doc-vitepress/components-mappen, må du restarte appen og kjøre `pnpm run dev` på nytt for å kunne se den i sidebaren.
