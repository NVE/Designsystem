...
2. **Rapporter i GitHub Issues**  
   Opplever du at det er noe som mangler, er utydelig eller feil? Vil vi gjerne du legger inn en issue i [GitHub](https://github.com/NVE/Designsystem/issues). Gjerne lag en oppgave på det i ditt Jira-board slik at produkteier har mulighet å prioritere inn oppgaven.

3. **Få tildelt oppgaven**  
   Gjerne tildel deg selv oppgaven fortløpene om det haster. Designsystemansvarlige vil vurdere og ofte sette deg på samme oppgave du har lagt inn. Om du ikke ønsker å jobbe med oppgaven eller ikke har tid, må du melde ifra til designsystemansvarlig.

4. **Løs oppgaven i Figma eller i kode**  
   Løs oppgaven du har fått tildelt i Figma eller i kode avhengig av oppgave. Sørg for at du forholder deg til retningslinjene satt i profilmanualen og i designsystemet, og sørg for at løsningen din oppfyller kravene til [universell utforming](../universellUtforming.md).

<br>
<nve-message-card label="Krav" size="compact">
  <ul>
