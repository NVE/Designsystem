...
meta:
  title: Alert
  description: Jadda Alerts are used to display important messages inline or as toast notifications.
layout: component
---

## TODO: Dette er bare en kopi av Shoelace sin dokumentasjonsside for sl-alert for å teste generering av dokumentasjon.
