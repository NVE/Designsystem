...
- Har du tilgang til Figmaskisser, legg disse ved slik at vi enkelt kan finne det igjen!

### 💡 Foreslå nye funksjoner

- Opprett en ny issue og merk den som en "feature request".
- Forklar hvorfor funksjonen er nyttig og hvordan den kan implementeres.
- Diskuter gjerne ideen med andre bidragsytere før du starter arbeidet.
...
- Oppdater eksisterende dokumentasjon hvis du finner feil eller mangler.
- Legg til ny dokumentasjon for nye funksjoner eller endringer.
...
- Følg prosjektets [Code of Conduct](#).
