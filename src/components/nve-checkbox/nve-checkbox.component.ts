...
/*
siden her kan checkkbox brukes separat og posisjonering og antall av sjekkboksene i gruppen er ikke så viktig så skal vi 
brule input inn i label slik at sjekkboks blir krysset nar ikke bare input men ogsa label klikkes pa


nevn at sweitch property ikke støttes fordi den er ikke fullstøttet men også vi har egen switch
skriv at checkbox mo ha en ledetekst
*/
